...
def _render_theory_content_html(content_value):
    ...
    def _code_repl(match):
        ...
        return (
            ...
            '<div class="flex items-center gap-2.5"><div class="w-2.5 h-2.5 rounded-full bg-[#F87171] border border-[#EF4444]"></div><div class="w-2.5 h-2.5 rounded-full bg-[#F59E0B] border border-[#D97706]"></div><div class="w-2.5 h-2.5 rounded-full bg-[#4ADE80] border border-[#22C55E]"></div>'
            ...
            '<button type="button" class="theory-run-btn px-2.5 py-1 text-xs font-bold text-white bg-[#15803D] hover:bg-[#166534] border border-[#14532D] rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#22C55E]/40">Run</button>'
            '</div>'
            '</div>'
